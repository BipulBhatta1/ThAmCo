...
{
    public class DodgyDealersService
    {
        private readonly HttpClient _httpClient;

        public DodgyDealersService(HttpClient httpClient)
        {
        ...
        {
            string url = "http://dodgydealers.azurewebsites.net/api/Product";
        ...
        {
            string url = "http://dodgydealers.azurewebsites.net/api/Category";
        ...
        {
            string url = "http://dodgydealers.azurewebsites.net/api/Brand";
        ...
        {
            string url = $"http://dodgydealers.azurewebsites.net/api/Order/{id}";
            return await _httpClient.GetFromJsonAsync<Order>(url);
        }

        public async Task<bool> CreateOrderAsync(Order order)
        {
            string url = "http://dodgydealers.azurewebsites.net/api/Order";
